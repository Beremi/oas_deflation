...
def readnext(file, accept_tokens=["MODEL", "ATOM", "CRYST1", "ENDMDL", "TER"]):
    '''
    ...
    while True:
        ...
        if record_name[0:5] == "TVECT":
            # in record_name[5] we have space
        ...
        if record_name[0:4] == "ATOM" or record_name == "HETATM":
            # in record_name[4:6] we have spaces
        ...
        if record_name[0:4] == "TER":
            # in record_name[3:6] we have spaces
            #  1 -  6         Record name       "TER   "

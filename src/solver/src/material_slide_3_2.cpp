...
Slide32MaterialStatus :: Slide32MaterialStatus(Slide32Material *m, Element *e, unsigned ipnum) : VectMechMaterialStatus(m, e, ipnum) {
...
Matrix Slide32MaterialStatus :: giveStiffnessTensor(string type) const {
    // TODO
...
bool Slide32MaterialStatus :: giveValues(string code, Vector &result) const {
    // TODO

...
double ShapeFunc::giveJacobian(const Matrix &JacobiM) const {
    if (ndim==1) return JacobiM[0][0];
    else if (ndim==2) return JacobiM[0][0] * JacobiM[1][1] - JacobiM[0][1] * JacobiM[1][0];
    else if (ndim==3) return JacobiM[0][0] * JacobiM[1][1] * JacobiM[2][2] - JacobiM[0][0] * JacobiM[1][2] * JacobiM[2][1] + JacobiM[0][1] * JacobiM[1][2] * JacobiM[2][0] - JacobiM[0][1] * JacobiM[1][0] * JacobiM[2][2] + JacobiM[0][2] * JacobiM[1][0] * JacobiM[2][1] - JacobiM[0][2] * JacobiM[1][1] * JacobiM[2][0];
    else return 0;
}

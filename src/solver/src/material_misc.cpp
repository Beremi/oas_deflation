...
//////////////////////////////////////////////////////////
Vector BrittleMaterialStatus :: giveStressWithFrozenIntVars(const Vector &strain) const{
...
//////////////////////////////////////////////////////////
Vector ContactMaterialStatus :: giveStressWithFrozenIntVars(const Vector &strain) const{
    return Vector(0); //TOTO: FIX
}

...
#OUTPUT METHODS
def output2D(node_count, dim, maxLim, vor, node_coords, node_mechBC, areas, reOrderedIdxs,mechanicalElements, mechBC_merged, transportPaths, materials, functions, diagonalize, order, points):
    ############################################################################################
    ############################################################################################
